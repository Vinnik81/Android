...
public class HumanVsPC_Hard extends AppCompatActivity {

    Button button1, button2, button3, button4, button5, button6, button7, button8, button9;
    String playerKrest, playerNol;
    TextView textView, humanPointsHard, pcPointsHard;
    int pointsHumanHard, pointsPCHard;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_human_vs_pc_hard);
        ...
        humanPointsHard = findViewById(R.id.humanPointsHard);
        pcPointsHard = findViewById(R.id.pcPointsHard);

        sharedPreferences = this.getSharedPreferences("tictactoe", Context.MODE_PRIVATE);
        editor = sharedPreferences.edit();
        pointsHumanHard = sharedPreferences.getInt("pointsHumanHard", 0);
        humanPointsHard.setText("" + pointsHumanHard);
        pointsPCHard = sharedPreferences.getInt("pointsPCHard", 0);
        pcPointsHard.setText("" + pointsPCHard);
    }
    ...
    public void isPlayerWin() {
        if (button1.getText() == playerKrest && button2.getText() == playerKrest && button3.getText() == playerKrest) {
            ...
            pointsHumanHard++;
            humanPointsHard.setText("" + pointsHumanHard);
            editor.putInt("pointsHumanHard", pointsHumanHard);
            editor.apply();
        }
    ...
    public void isPCWin() {
        if (button1.getText() == playerNol && button2.getText() == playerNol && button3.getText() == playerNol) {
            ...
            pointsPCHard++;
            pcPointsHard.setText("" + pointsPCHard);
            editor.putInt("pointsPCHard", pointsPCHard);
            editor.apply();
        }
    ...
    private void hodPC() {
        if (button1.getText() == "" && (button2.getText() == playerNol && button3.getText() == playerNol) ||
        button4.getText() == "" && (button5.getText() == playerNol && button6.getText() == playerNol) ||
        button7.getText() == "" && (button8.getText() == playerNol && button9.getText() == playerNol) ||
        button1.getText() == "" && (button4.getText() == playerNol && button7.getText() == playerNol) ||
        button2.getText() == "" && (button5.getText() == playerNol && button8.getText() == playerNol) ||
        button3.getText() == "" && (button6.getText() == playerNol && button9.getText() == playerNol) ||
        button1.getText() == "" && (button5.getText() == playerNol && button9.getText() == playerNol) ||
        button3.getText() == "" && (button5.getText() == playerNol && button7.getText() == playerNol)) {
            if (button1.getText() == "") {
        ...
        if (button1.getText() == playerKrest && button2.getText() == playerKrest && button3.getText() == "") {
            button3.setText(playerNol);
            isPCWin();
            return;
        } else if (button4.getText() == playerKrest && button5.getText() == playerKrest && button6.getText() == "") {
            button6.setText(playerNol);
            isPCWin();
            return;
        } else if (button7.getText() == playerKrest && button8.getText() == playerKrest && button9.getText() == "") {
            button9.setText(playerNol);
            isPCWin();
            return;
        } else if (button1.getText() == playerKrest && button4.getText() == playerKrest && button7.getText() == "") {
            button7.setText(playerNol);
            isPCWin();
            return;
        } else if (button2.getText() == playerKrest && button5.getText() == playerKrest && button8.getText() == "") {
            button8.setText(playerNol);
            isPCWin();
            return;
        } else if (button3.getText() == playerKrest && button6.getText() == playerKrest && button9.getText() == "") {
            button9.setText(playerNol);
            isPCWin();
            return;
        } else if (button1.getText() == playerKrest && button5.getText() == playerKrest && button9.getText() == "") {
            button9.setText(playerNol);
            isPCWin();
            return;
        } else if (button3.getText() == playerKrest && button5.getText() == playerKrest && button7.getText() == "") {
            button7.setText(playerNol);
            isPCWin();
            return;
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(HumanVsPC_Hard.this, MainActivity.class);
    ...
    public void onSettingClick(View view) {
        Intent intent = new Intent(HumanVsPC_Hard.this, SettingsTicTacToe.class);
        startActivity(intent);
        finish();
    }
}